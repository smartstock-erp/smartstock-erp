...
# -----------------------------------------------------------------------------
# الهوية البصرية والواجهة الطبية الخضراء الاحترافية (مع خلفية صورة طبية شفافة)
# -----------------------------------------------------------------------------
st.markdown("""
    <style>
    ...
    .stApp {
        /* دمج خلفية صورة طبية احترافية مع طبقة خضراء فاتحة وشفافة لراحة العين ونقاء النصوص */
        background: linear-gradient(rgba(244, 251, 247, 0.93), rgba(244, 251, 247, 0.95)), 
